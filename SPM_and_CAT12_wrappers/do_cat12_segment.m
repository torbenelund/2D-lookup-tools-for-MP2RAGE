...
matlabbatch{4}.spm.tools.cat.estwrite.nproc = 1;
...
matlabbatch{4}.spm.tools.cat.estwrite.extopts.registration.T1 =             {[spm('DIR') filesep 'toolbox/cat12/templates_MNI152NLin2009cAsym' filesep 'T1.nii']};
matlabbatch{4}.spm.tools.cat.estwrite.extopts.registration.brainmask =      {[spm('DIR') filesep 'toolbox/cat12/templates_MNI152NLin2009cAsym' filesep 'brainmask.nii']};
