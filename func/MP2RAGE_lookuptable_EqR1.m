...
function [Intensity, T1vector, IntensityBeforeComb] = MP2RAGE_lookuptable_EqR1(nimages,MPRAGE_tr,invtimesAB,flipangleABdegree,nZslices,FLASH_tr,sequence,varargin)
...
T1vector    = 1./[R1Max:-R1Step:R1Min];
%T1vector    =0.05:0.005:5;
