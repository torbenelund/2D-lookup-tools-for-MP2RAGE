function plotMP2RAGEpropertiesB1Select(MP2RAGE,B1range, HG)
...
legend({legendcell{:} 'CSF' 'GM' 'WM' })
text(0.35, T1CSF+0.2, 'CSF','FontSize',20,'FontWeight','bold')
text(0.35, T1WM+0.2, 'WM','FontSize',20,'FontWeight','bold')
text(0.35, T1GM+0.2, 'GM','FontSize',20,'FontWeight','bold')
