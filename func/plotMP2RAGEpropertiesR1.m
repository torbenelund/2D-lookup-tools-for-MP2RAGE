function plotMP2RAGEpropertiesR1(MP2RAGE,B1range, HG)
...
for B1 = B1range
    ...
    plot(MP2RAGEamp, 1./T1vector, 'color',[0.5 0.5 0.5]*B1, 'Linewidth',2)
    hold on
...
plot([-0.5 0.5], [1/T1CSF 1/T1CSF; 1/T1GM 1/T1GM; 1/T1WM 1/T1WM]', 'Linewidth',2)
text(0.35, 1/T1WM+0.1, 'White Matter')
text(0.35, 1/T1GM+0.1, 'Grey Matter')
text(0.35, 1/T1CSF+0.1, 'CSF')
