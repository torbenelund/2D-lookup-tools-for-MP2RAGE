...
nexttile(1,[2 1]),h = plot3(UNI,DSR,R1,'k-');box on, grid on,xlabel('UNI'),ylabel('DSR'),zlabel('R_1 [s^{-1}]'),
...
nexttile(2,[2 1]),h = plot3(UNI,DSR,R1,'k-');box on, grid on,xlabel('UNI'),ylabel('DSR'),zlabel('R_1 [s^{-1}]'),
set(h,'LineWidth',2,'Color',cm)
view(90,0)
xlim([-0.5 0.5])
ylim([-0.5 0.5])
