...
MainDirec               = '/Volumes/SanDiskSSD1/HDMP2RAGE/Human/S1/2024-06-14/NIFTI';
...
if DoCoregister
    RefIdx      = contains({MP2RAGE.filenamecalcR1_1DLUT},'Standard_FA100_1');
    clear matlabbatch
    
    for d = 1 : size(subdirs,1)
        
        if ~strcmp(subdirs(d,:),'Standard_FA100_1')
